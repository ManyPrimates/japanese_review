...
ggtree(div_tree3, aes(color = div_score))+#, layout = "circular")+
  ...
  scale_color_gradient2(high = "#009E73", mid = "grey", low = "#E69F00", midpoint = .5, name = "#Studies / #Sites", limits = c(0,1))+
...
```{r, cache=TRUE}
ggsave("../graphs/diversity_tree.pdf", width = 8, height = 8, scale = 1)
```
