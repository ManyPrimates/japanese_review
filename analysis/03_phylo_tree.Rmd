...
q %>% 
  ...
  # x for Mdn_site
  facet_plot("xSample size", d4, geom_point, aes(x = Mdn_site2, group = label), shape = 4, size = 2, stroke = 1.5, alpha = .8) %>%
  # vertical mark for individual sites
  facet_plot("xSample size", d3b, geom_point, aes(x = num2, group = label), shape = "|", size = 3) #+
```
